...
{
    using Comp = vector_component_t<TVec2>;
...
template<is_vector2 TVec2>
constexpr TVec2& operator/=(TVec2& lhs, const vector_component_t<TVec2> rhs) noexcept
{
    lhs.data[0] /= rhs;
    lhs.data[1] /= rhs;
    return lhs;
...
template<is_vector2 TVec2>
constexpr vector_component_t<TVec2> dot(const TVec2& lhs, const TVec2& rhs) noexcept
{
    return lhs.data[0] * rhs.data[0] + lhs.data[1] * rhs.data[1];
}
...
template<is_vector2 TVec2>
constexpr vector_component_t<TVec2> cross(const TVec2& lhs, const TVec2& rhs) noexcept
{
    return lhs.data[0] * rhs.data[1] - lhs.data[1] * rhs.data[0];
}

template<is_vector2_floating_point TVec2>
bool approximately(const TVec2& a, const TVec2& b, const vector_component_t<TVec2> tolerance = MinTolerance<vector_component_t<TVec2>>) noexcept
{
...
template<is_vector2_floating_point TVec2>
vector_component_t<TVec2> magnitude(const TVec2& v) noexcept
{
...
{
    using F = vector_component_t<TVec2>;
...
{
    using F = vector_component_t<RetVec2>;
...
template<is_vector2_floating_point TVec2>
vector_component_t<TVec2> distance(const TVec2& a, const TVec2& b) noexcept
{
    return magnitude(a - b);
}

template<is_vector2_sint TVec2Int>
sint_to_floating_point_t<vector_component_t<TVec2Int>> distance(const TVec2Int& a, const TVec2Int& b) noexcept
{
    using F = sint_to_floating_point_t<vector_component_t<TVec2Int>>;
