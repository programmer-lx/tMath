...
#define TSIMD_DYN_INSTRUCTION TSIMD_DETAIL_DYN_DISPATCH_NS_PREFIX::SSE2
...
// AVX
#undef TSIMD_DYN_INSTRUCTION
#define TSIMD_DYN_INSTRUCTION TSIMD_DETAIL_DYN_DISPATCH_NS_PREFIX::AVX
...
#undef TSIMD_DYN_INSTRUCTION
#define TSIMD_DYN_INSTRUCTION TSIMD_DETAIL_DYN_DISPATCH_NS_PREFIX::Scalar
